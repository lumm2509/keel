...
func TestNewNotFoundError(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := http.NewNotFoundError(s.message, s.data)
			result, _ := json.Marshal(e)
...
func TestNewBadRequestError(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := http.NewBadRequestError(s.message, s.data)
			result, _ := json.Marshal(e)
...
func TestNewForbiddenError(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := http.NewForbiddenError(s.message, s.data)
			result, _ := json.Marshal(e)
...
func TestNewUnauthorizedError(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := http.NewUnauthorizedError(s.message, s.data)
			result, _ := json.Marshal(e)
...
func TestNewInternalServerError(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := http.NewInternalServerError(s.message, s.data)
			result, _ := json.Marshal(e)
...
func TestNewTooManyRequestsError(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := http.NewTooManyRequestsError(s.message, s.data)
			result, _ := json.Marshal(e)
...
func TestApiErrorIs(t *testing.T) {
	...
	err0 := http.NewInternalServerError("", nil)
	err1 := http.NewInternalServerError("", nil)
...
func TestToApiError(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			"ApiError",
			http.NewForbiddenError("test", nil),
			`{"data":{},"message":"Test.","status":403}`,
		},
		{
			"wrapped ApiError",
			fmt.Errorf("wrapped: %w", http.NewForbiddenError("test", nil)),
			`{"data":{},"message":"Test.","status":403}`,
		},
	}
	...
	for _, s := range scenarios {
		t.Run(s.name, func(t *testing.T) {
			raw, err := json.Marshal(http.ToApiError(s.err))
			if err != nil {
				t.Fatal(err)
			}
			rawStr := string(raw)
...
var (
	_ http.SafeErrorItem     = (*mockSafeErrorItem)(nil)
	_ http.SafeErrorResolver = (*mockSafeErrorItem)(nil)
)
