...
func createTestDB() (*testDB, error) {
	...
	db.Insert("test", Params{"id": 1, "test1": 1, "test2": "test2.1"}).Execute()
	db.Insert("test", Params{"id": 2, "test1": 2, "test2": "test2.2"}).Execute()
...
func (t *testFieldResolver) UpdateQuery(query *SelectQuery) error {
	t.UpdateQueryCalls++
	return nil
}
